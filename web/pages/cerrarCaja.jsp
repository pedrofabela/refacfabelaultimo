                ...
                <div class="div-contenido_gral">  
                    ...
                    <s:hidden name="usuariocons.NAMEUSUARIO" id="%{usuariocons.NAMEUSUARIO}"></s:hidden> 
                        ...
                        <article class="articulo2">
                            ...
                            <div class="div_titulos_sec"> <h2 class="text-tit-sec">Lista de productos vendidos de la nota: <s:property value="camp.NO_VENTA" /> </h2></div>
                                    ...
                                    <table id="customers">
                                        <thead>
                                         ...
                                         <tr>
                                                ...
                                                <td id="centrar-dato" style="background: purple; color:white; "><s:property value="camp.TOTAL_VENTA_DETALLE"  /></td>
                                                <td  id="centrar-dato"> </td>
                                                ...
                                                <div style="width: 200px; height: 25px; background: purple; color: white; float: right; margin-right: 120px; text-align: center; margin-top: 10px; font-size: 14px;">Total: <s:property value="camp.TOTAL_VENTA_DETALLE" /> MXN</div>
...
<s:textfield type="text" name="camp.NO_VENTA" id="NO_VENTA"    ></s:textfield>
        </s:form>
