 ...
 * @author pedro
 */
public class productosGralMapper implements Mapper {
          ...
          if (rs.getString("PRECIO_CAL") != null) {
           ...
           if (rs.getString("PROVEEDOR") != null) {
            ...
            usr.setCATEGORIA_GENERAL(rs.getString("CATEGORIA_GENERAL"));
              ...
              if (rs.getString("FECHA_ACTUALIZA") != null) {
            usr.setFECHA_ACTUALIZA(rs.getString("FECHA_ACTUALIZA").trim());
        } else {
            usr.setFECHA_ACTUALIZA(rs.getString("FECHA_ACTUALIZA"));
        }
